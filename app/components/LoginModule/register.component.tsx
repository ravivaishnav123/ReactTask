            ...
            <View style={{backgroundColor: Colors.black}}>
              <View style={styles.container}>
                <Text style={styles.textInputHeader}>
                  {I18n.translate('Register.Full Name')}
                </Text>
                <TextInput
                ...
                <View style={{marginTop: 15}}>
                  ...
                  <TextInput
                    ...
                    placeholder={I18n.translate(
                      'Register.Enter Your Mobile Number',
                    )}
                    onSubmitEditing={(event) => {
                ...
                <View style={styles.marginTop15}>
                  <Text style={styles.textInputHeader}>
                    {I18n.translate('Register.Password')}
                  </Text>
                  <TextInput
                    ref={passwordRef}
                    style={styles.textInputValue}
                ...
                <View style={{marginTop: 15}}>
                  <Text style={styles.textInputHeader}>
                    {I18n.translate('Register.Confirm Password')}
                  </Text>
                  <TextInput
                ...
                <View style={styles.bottomView}>
                  <Text style={styles.haveAccountText}>
                    {I18n.translate('Register.HAVE AN ACCOUNT?')}
                  </Text>
                  <Text
                    style={styles.signUpText}
                    onPress={() => this.navigateToLogin()}>
                    {I18n.translate('Register.Login')}
                  </Text>
                </View>
              </View>
              <ActivityIndicator
